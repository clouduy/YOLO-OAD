...
def train(opt, device):
    ...
    test_dir = data_dir / "val" if (data_dir / "val").exists() else data_dir / "val"  # data/test or data/val
    if RANK in {-1, 0}:
...
def parse_opt(known=False):
    ...
    parser.add_argument("--model", type=str, default=r"E:\YOLO-OAD\models\YOLO-OAD.yaml", help="initial weights path")
    parser.add_argument("--data", type=str, default="E:\Folder\dataset\Flower\dataset", help="cifar10, cifar100, mnist, imagenet, ...")
