...
import cv2
# 数据集类别名
names = ['person', 'rider','car','bus','truck','bike','motor','traffic light','traffic sign']  # class names
# yolov5s网络中的三个detect层
target_layers = ['model_17', 'model_20', 'model_23']

# Arguments
parser = argparse.ArgumentParser()
parser.add_argument('--model-path', type=str, default="runs/train/exp214/weights/best.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default='data/images/3.png', help='input image path')
parser.add_argument('--output-dir', type=str, default='runs/detect', help='output dir')
